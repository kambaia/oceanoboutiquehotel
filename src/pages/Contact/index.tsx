...
export default function ContactPage() {
    return (
        ...
        <Layout>
            ...
            <Container>
                <div className="w-full py-32 px-20 my-20 bg-[#4C96FF] flex flex-row justify-around max-lg:p-5 flex-wrap">
                    <div >
                        <div className="bg-white w-[450px] relative z-20 flex flex-col gap-4 p-20 max-lg:w-full max-lg:h-auto max-lg:p-5">
                            ...
                            <div className="flex flex-row items-center gap-3 mt-4">
                                <div className="bg-gradient-to-r from-[#5AC2FF] to-orange-500 p-3 rounded-full w-[50px] h-[50px] flex justify-center items-center text-white text-xl">
                                    <FaLocationDot />
                                </div>
                    ...
                    <div className="w-[600px] p-6 flex flex-col gap-14 max-lg:gap-6 max-lg:p-0 max-lg:pt-6">
                        ...
                        <div className="w-full">
                            <button className="flex flex-row items-center gap-1 text-[#5AC2FF] bg-white p-4 px-6 rounded-md">
