    ...
    return (
        <Container>
            <div className="our-why w-full flex flex-col md:flex-row justify-around py-20 gap-8">
                ...
                <div className="macro-content w-full md:w-[40%] flex flex-col gap-1 justify-center" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="200">
                    <h3 className="section-titles text-[#4C96FF] text-lg font-medium">O NOSSO PORQUÊ</h3>
