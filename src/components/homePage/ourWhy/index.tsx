    ...
    return (
        <Container>
            <div className="w-full flex flex-row justify-around" >
                ...
                <div className="w-[60%] h-[600px]" data-aos="fade-left">
                ...
                <div className="w-[40%] mt-20 flex flex-col gap-1" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
