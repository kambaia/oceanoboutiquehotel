        ...
        <Container>
            <div className="w-full py-16 flex flex-col justify-center items-center gap-2">
                <div className="flex flex-row gap-3 items-center">
                    ...
                    <h1 className="text-4xl font-bold text-blue-600">PERSONALIZADO</h1>
                    <GoDotFill className="text-2xl text-blue-600" />
                </div>
                <p className="w-[750px] text-center text-lg">Na <b>AGROPEC</b> você conta com Soluções Diferenciadas e Personalizadas com foco na sua real necessidade para aumentar a sua produtividade e rentabilidade.</p>
                <h1 className="text-2xl font-medium mt-4 text-blue-600">CONFIRA COMO FUNCIONA O NOSSO ATENDIMENTO:</h1>
                <div className="flex flex-row justify-between w-full mt-10">
                    <div className="w-[320px] p-7 h-28 bg-blue-600 rounded-tr-[50px] rounded-bl-[50px] flex flex-row gap-2 justify-start items-center">
                ...
                <div className="flex flex-col gap-8  w-[600px]  mt-10">
                    <p className="text-lg text-center">Somos um dos maiores e melhores escritórios de Consultoria e Assessoria Financeira para o Agronegócio do Brasil.</p>
                    <h1 className="text-2xl text-center font-bold text-blue-600">O SEU RESULTADO É A NOSSA MISSÃO!<br/> 100% DOS NOSSOS PROJETOS SÃO APROVADOS.</h1>
                </div>
            </div>
        </Container>
    )
